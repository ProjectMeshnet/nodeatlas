function createMessageForm(name, ipv6) {
	var html = '<div id="messageCreate">';
		html += '<div id="one">';
			...
			html += '<input type="email" placeholder="Your Email" id="from" class="form-control" required>';
			html += '<br/><input type="text" id="address" value="'+ipv6+'" class="form-control" disabled class="hidden">';
			html += '<br/><input type="text" placeholder="Subject" class="form-control" id="subject" required>';
			html += '<br/><textarea placeholder="Body" id="message" class="form-control" required></textarea>';
		...
		html += '</div><div id="two">';
			...
			html += '<br/><input type="text" placeholder="Captcha" class="form-control" id="captcha" required>';
...
function getForm(lat, lng) {
	...
	form += '<div class="tabby">';
		form += '<div class="tab" id="one">';
			...
			form += '<input type="email" class="input-medium form-control" placeholder="Required" id="email" name="email" />';
