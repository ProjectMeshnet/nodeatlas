...
function search(nodes, query) {
	...
	// highlights is a map of property names to: arrays of
	// 2-element arrays representing start and stop highlight
	// points booleans, with true meaning it is all highlighted
	// and false meaning no match
	curNode.highlights = {};
